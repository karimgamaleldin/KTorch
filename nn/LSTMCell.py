...
class LSTMCell(Module):
  ...
  def parameters(self):
    out = [self.w_ii, self.w_if, self.w_ig, self.w_io, self.w_hi, self.w_hf, self.w_hg, self.w_ho]
    if self.bias:
      out.extend([self.b_ii, self.b_if, self.b_ig, self.b_io, self.b_hi, self.b_hf, self.b_hg, self.b_ho])
    return out